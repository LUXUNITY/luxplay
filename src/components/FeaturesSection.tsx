...
const FeaturesSection = () => {
  return (
    ...
    >
      {/* Blurred arcade background at low opacity */}
      <img
        src={arcadeHero}
        alt=""
        aria-hidden="true"
      ...
      <div className="relative z-10 px-6 md:px-12 lg:px-20 py-14 md:py-20 lg:py-24">
        {/* ===== TOP: Cinematic horizontal — portrait left, statement right ===== */}
        <div className="flex flex-col md:flex-row gap-8 md:gap-14 lg:gap-20 items-stretch min-h-[50vh] md:min-h-[55vh]">
          {/* Portrait — real image element, large, fills left column */}
          <motion.div
            initial={{ opacity: 0, x: -30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="w-full md:w-[40%] lg:w-[38%] flex-shrink-0"
          >
            <div className="relative h-full">
              <img
                src={founderBaz}
                alt="Baz — Founder of LuxPlay"
                className="w-full h-full object-cover object-top rounded-sm min-h-[350px] md:min-h-full"
              />
              {/* Name badge */}
              ...
              {/* Ambient glow */}
              <div className="absolute -inset-6 bg-gradient-to-br from-neon-cyan/8 via-transparent to-neon-pink/8 rounded-xl -z-10 blur-2xl" />
            </div>
          </motion.div>

          {/* Right: personal statement — cinematic, large type */}
          <motion.div
          ...
          >
            <p className="font-display text-base md:text-lg lg:text-xl font-bold uppercase tracking-[0.15em] text-foreground/80">
              While Everyone Is Closing —
            </p>
            <h2 className="font-display text-4xl md:text-6xl lg:text-7xl font-black uppercase leading-[0.85] mt-1 mb-8 md:mb-10">
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <p className="text-foreground text-xl md:text-2xl lg:text-3xl font-bold">
        ...
        <div className="mt-14 md:mt-20">
          ...
          <div className="flex flex-col md:flex-row gap-10 md:gap-16 lg:gap-20">
            ...
            >
              ...
              <p className="text-foreground font-bold text-xl md:text-2xl lg:text-3xl">
                This is just the beginning.
              </p>
            </motion.div>

            {/* Right: neon value bullets — large and dominant */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
        ...
        {/* LUXPLAY anchor */}
        <div className="mt-10 md:mt-14 flex flex-col md:flex-row items-center justify-between gap-4">

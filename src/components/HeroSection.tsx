const HeroSection = () => {
  return (
    <section className="relative w-full bg-background overflow-hidden">
      ...
      {/* Live, clickable CTAs sit just below the video */}
      <div className="relative z-10 w-full flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center px-6 py-8 md:py-12">
        <a
          href="#presale"

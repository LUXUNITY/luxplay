...
const HeroSection = () => {
  return (
    <section className="relative min-h-[100svh] w-full overflow-hidden bg-background">
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] w-full max-w-[640px] flex-col items-center justify-between px-3 pb-4 pt-4 text-center sm:max-w-[760px] md:max-w-[1100px] md:pt-6">
        {/* LUXPLAY wordmark — transparent */}
        <div className="animate-fade-in flex w-full flex-col items-center">
          <img
            src={wordmark}
            alt="LuxPlay — arcade, soft play, café and prizes"
            className="h-auto w-[78%] max-w-[560px] drop-shadow-[0_0_24px_hsl(var(--neon-cyan)/0.55)]"
            loading="eager"
          />
        </div>

        {/* WE'RE / OPENING — stacked, massive, fills the screen */}
        <div className="my-2 flex w-full flex-col items-center">
          <h1 className="font-display leading-[0.82] tracking-[0.005em] flex flex-col items-center">
            <span className="hero-flash text-[6.5rem] sm:text-[10rem] md:text-[14rem]">
              WE'RE
            </span>
            <span className="hero-flash text-[7.5rem] sm:text-[12rem] md:text-[16rem]" style={{ animationDelay: '0.2s' }}>
              OPENING!
            </span>
          </h1>
        ...
        {/* Arcade + Soft Play image grid — BIG */}
        <div className="grid w-full grid-cols-2 gap-2.5 sm:gap-3">
          <a
            href="#presale"
            className="hero-tile group relative block overflow-hidden rounded-sm border-2 border-neon-pink/70 transition-transform duration-200 hover:scale-[1.02]"
          >
            <img
              src={arcadeImg}
            ...
            <div className="absolute inset-x-0 bottom-0 p-2.5 text-left">
              <span className="block font-display text-[1.4rem] leading-none text-neon-pink glow-pink sm:text-[1.8rem] md:text-[2.2rem]">
                ARCADE
              </span>
              <span className="mt-1 block font-display text-[0.75rem] tracking-[0.16em] text-foreground/90 sm:text-[0.95rem]">
                WIN BIG PRIZES
              </span>
            </div>
          </a>
          ...
          <a
            href="#softplay"
            className="hero-tile group relative block overflow-hidden rounded-sm border-2 border-neon-green/70 transition-transform duration-200 hover:scale-[1.02]"
          >
            <img
              src={softplayImg}
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-background/20 to-transparent" />
            <div className="absolute inset-x-0 bottom-0 p-2.5 text-left">
              <span className="block font-display text-[1.4rem] leading-none text-neon-green glow-green sm:text-[1.8rem] md:text-[2.2rem]">
                SOFT PLAY
              </span>
              <span className="mt-1 block font-display text-[0.75rem] tracking-[0.16em] text-foreground/90 sm:text-[0.95rem]">
                BALL PIT • SLIDES

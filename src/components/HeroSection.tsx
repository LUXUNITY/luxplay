...
const HeroSection = () => {
  ...
  return (
    <section className="hero-space relative min-h-[100svh] w-full overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_95%,hsl(240_60%_2%/0.92),transparent_44%)]" aria-hidden />
      ...
      <div className="relative z-20 mx-auto flex min-h-[100svh] w-full max-w-[680px] flex-col px-4 pb-4 pt-4 text-center sm:max-w-[840px] md:max-w-[1080px] md:pt-7">
        <div className="flex flex-col items-center gap-2.5">
          ...
          <div className="grid w-full grid-cols-[0.95fr_1.2fr_0.95fr] items-stretch gap-2 sm:gap-3">
            ...
            <div className="hero-offer-card relative flex flex-col items-center justify-center rounded-[1.7rem] border-2 border-neon-cyan/85 bg-background/78 px-2 py-3 backdrop-blur-md sm:py-5">
              ...
              <div className="font-display text-[0.82rem] tracking-[0.12em] text-neon-pink glow-pink sm:text-[1rem]">
                DISCOUNTED
              </div>
            ...
            <a
              ...
              className="hero-reference-tile hero-reference-right group relative block overflow-hidden rounded-[1.35rem] border-2 border-neon-cyan/85"
            >
              <img
                src={softplayImg}
          ...
          <div className="grid w-full grid-cols-2 gap-2 sm:gap-3">
            <a
              ...
              className="hero-action-card hero-action-card-pink group flex min-h-[7.75rem] items-center gap-3 rounded-[1.5rem] border-2 border-neon-pink/85 bg-background/82 px-4 py-3 backdrop-blur-md transition-transform duration-200 hover:scale-[1.02]"
            >
              <svg
                viewBox="0 0 32 32"
              ...
              <span className="flex flex-col items-start leading-tight text-left">
                <span className="text-[1.22rem] text-foreground sm:text-[1.55rem]">BOOK NOW</span>
            ...
            <a
              ...
              className="hero-action-card hero-action-card-cyan group flex min-h-[7.75rem] items-center gap-3 rounded-[1.5rem] border-2 border-neon-cyan/85 bg-background/82 px-4 py-3 backdrop-blur-md transition-transform duration-200 hover:scale-[1.02]"
            >
              <svg
                viewBox="0 0 32 32"
        ...
        <div className="mt-auto pt-3">
          <div className="flex w-full items-center justify-center gap-3 font-display text-[0.74rem] tracking-[0.15em] text-foreground sm:text-[0.88rem]">

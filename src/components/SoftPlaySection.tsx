...
import { getAvailableDates, getSlotsForDate, getSoftPlayPrice, getSoftPlayFullPrice, isOpeningWeekend, isSlotForcedFull, isSoftPlaySlotBlocked, getHeldSpots } from "./softplay/dateSlots";
              ...
              <div>
                ...
                <div className="flex items-center justify-between bg-card rounded-2xl px-2 py-2">
                  <button
                    ...
                    className="w-12 h-12 rounded-xl flex items-center justify-center bg-neon-cyan disabled:opacity-30 disabled:cursor-not-allowed active:translate-y-1 transition-transform"
                  >
                    <Minus className="w-5 h-5 text-foreground" />
                  </button>
                  <div className="text-center">
                    <p className="font-display text-3xl font-extrabold text-foreground">{childCount}</p>
